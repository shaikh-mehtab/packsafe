...
const {
  ...
  createMainMenu,
  deleteMainMenu,
} = require("../../Controllers/CMS_Controllers/main_menu.js");
...
const {
  ...
  deleteSpecialPrice,
} = require("../../Controllers/CMS_Controllers/special_price.js");
...
const { sendEmail } = require("../../Controllers/CMS_Controllers/send_email.js");


const { getAllVendor } = require("../../Controllers/CMS_Controllers/vendor.js");
...
/***MainMenu */
router.get("/getAllMainMenu", getAllMainMenu);
router.get("/getByIdMainMenu/:id", getByIdMainMenu);
router.post("/createMainMenu", createMainMenu);
router.put("/updateByIdMainMenu/:id", updateByIdMainMenu);
router.delete("/deleteByIdMainMenu/:id", deleteMainMenu);

/***SpecialPrice */
router.get("/getAllSpecialPrice", getAllSpecialPrice);
router.get("/getByIdSpecialPrice/:id", getByIdSpecialPrice);
router.post("/createSpecialPrice", createSpecialPrice);
router.put("/updateByIdSpecialPrice/:id", updateByIdSpecialPrice);
router.delete("/deleteByIdSpecialPrice/:id", deleteSpecialPrice);
...
router.put("/updateByIdSortOrder/:id", updateByIdSortOrder);
...
router.put("/updateByIdOrdersVendor/:id", updateByIdOrdersVendor);
